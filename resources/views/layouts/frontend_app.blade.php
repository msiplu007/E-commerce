                        ...
                        <nav class="mainmenu">
                            <ul class="d-flex">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown_style">
                                        <li><a href="{{url('shop')}}">Shop Page ({{total_product_count()}}) </a></li>
                                  ...
                                  @foreach (cart_items() as $cart_item)
                                    ...
                                    <li class="cart-items">
                                        ...
                                        <div class="cart-content">
                                            ...
                                            <span>{{$cart_item->product_quentity}}</span>
                                            <p>${{$cart_item->product_quentity * $cart_item->product->product_price}}</p>
                                            <i class="fa fa-times"></i>
                                            @php

                                            $sub_total = $sub_total + ($cart_item->product_quentity * $cart_item->product->product_price)
                                            @endphp
