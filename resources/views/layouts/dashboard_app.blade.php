...
<head>
    ...
    {{-- <meta  content="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css"> --}}
    ...
    <title>
       @yield('title', 'Spiderman | Dashboard' )
    </title>

    <!-- vendor css -->
    <link href="{{asset('dashboard_asset')}}/lib/font-awesome/css/font-awesome.css" rel="stylesheet">
    <link href="{{asset('dashboard_asset')}}/css/all.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="sl-sideleft">
        ...
        <a href="{{url('home')}}" class="sl-menu-link @yield('home')">
            ...
            <a href="{{url('contact')}}" class="sl-menu-link @yield('contact')">
                <div class="sl-menu-item">
                    <i class="menu-item-icon icon ion-ios-photos-outline tx-20"></i>
