                 ...
                 <div class="col-lg-6">
                     <div class="product-single-img">
                         <div class="product-active owl-carousel">
                             ...
                             {{-- @foreach ($product_info->ontomanyrelationwithproductimagetable as $single_photo)
                               <div class="item">
                 ...
                 <div class="col-lg-6">
                     <div class="product-single-content">
                         ...
                         <ul class="input-style">
                           <form class="" action="{{url('cart/stote')}}" method="post">
                             @csrf

                             <input type="hidden" name="product_id" value="{{$product_info->id}}">
                             <li class="quantity cart-plus-minus">
                                 <input type="text" value="1" name="product_quentity">
                             </li>
                             <li><button class="btn btn-danger" href="cart.html">Add to Cart</button></li>
                                  </form>
                         </ul>
                         <ul class="cetagory">
                             <li>Categories:</li>
